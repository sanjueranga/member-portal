...
import { updateAll, getUserById } from '../features/users/userSlice';
	...
	return (
		<>
			<div className="flex flex-col w-[80%] mx-auto mt-16 lg:flex-row">
				<div className="grid flex-2 place-content-start shadow bg-base-300 rounded-box place-items-center p-6 h-fit">
				...
				/>{' '} */}
					...
					<div className="flex items-center ">
						<h2 className="mb-4 pt-4 text-2xl text-white font-bold pr-4">
							{profileOwner.name}{' '}
						</h2>
					...
					<p className="text-xl mb-6">{profileOwner.headline}</p>
					<div>
				...
				<div className="grid flex-2 shadow bg-base-300 rounded-box ">
					<div className="px-4 py-2 mx-5 mt-5  bg-slate-700 rounded-t-lg sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 items-center">
						<dt className="text-base font-medium text-gray-200">Name</dt>
						<dd className="mt-1 text-base text-gray-200 sm:mt-0 sm:col-span-2">
							{profileOwner.name}{' '}
						</dd>
					</div>
					<div className="px-4 py-2 items-center  mx-5 bg-slate-800 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
						<dt className="text-base font-medium text-gray-200">Email</dt>
						<dd className="mt-1 flex text-base text-gray-200 sm:mt-0 sm:col-span-2">
							{profileOwner.email}{' '}
							<a href={`mailto: ${profileOwner.email}`}>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									className="icon ml-3 icon-tabler icon-tabler-send"
									width="24"
									height="24"
									viewBox="0 0 24 24"
									strokeWidth="1.5"
					...
					<div className="px-4 py-2 items-center mx-5 bg-slate-700 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
						<dt className="text-base font-medium text-gray-200">About</dt>
						<dd className="mt-1 text-base text-gray-200 sm:mt-0 sm:col-span-2 text-justify">
							{profileOwner.about}
						</dd>
					</div>
					...
					<div className="px-4 py-2 items-center mx-5 bg-slate-800 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
						...
						<dd className="mt-1 text-base text-gray-200 sm:mt-0 sm:col-span-2">
							{isSuccess ? (
								skills.map((skill) => (
									<span
										className="badge m-1 hover:badge-info cursor-pointer"
										key={skill}
									>
										{skill}
									</span>
					...
					<div className="px-4 py-2 items-center mx-5 mb-5 rounded-b-lg bg-slate-700 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
						<dt className="text-base font-medium text-gray-200">Gender</dt>
						<dd className="mt-1 text-base text-gray-200 sm:mt-0 sm:col-span-2">
							{profileOwner.gender}
						</dd>
					</div>
					<div className="px-4 py-2 items-center mx-5  mb-5 rounded-b-lg sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
					...
					{user ? (
						user.role === 'Admin' ? (
							<div className="px-4 py-2 mb-5  items-center mx-5 rounded-b-lg bg-slate-700 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								<dt className="text-base font-medium text-gray-200">
									Approved By
								</dt>
								<dd className="mt-1 text-base text-gray-200 sm:mt-0 sm:col-span-2">
								...
								<div className="modal-box ">
									...
									<form onSubmit={onAddProject}>
										...
										<div className="col-span-6 sm:col-span-3 lg:col-span-2">
											...
											<p className="mt-2 text-sm text-gray-400">
												Enter your Technology Stacks seperated by comma (' , ') eg -
												html,css,reactjs
											</p>
										</div>
